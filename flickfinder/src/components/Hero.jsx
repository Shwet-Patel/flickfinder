  ...
  return (
    ...
    <div className='absolute min-h-[80vh] min-w-full top-0 left-0 bg-[linear-gradient(rgba(1,0,5,0.3),rgba(4,1,17,0.3))]'>
      <div className=' grid mt-48 w-full justify-center'>
        ...
        <h1 className='mt-1 text-xl font-sembold text-center '>Millions of movies, TV shows and people to discover. Explore now</h1>
        <div className='mt-4 px-2 py-2 rounded-3xl bg-white text-black justify-self-center'>
          <input 
